...
public class MajorChangeTest1 {
    ...
    public void test2(){
        ...
        StudentTransferMajorDocument application1 = service.getApplicationById(id);
        log.info("获取指定 ID 实例 \n" + application1);
    }
    ...
    public void test3(){
        String id = "6555b08ab1d3e01affffcb11";
        StudentTransferMajorDocument application = service.updateMajor(id, "计算机科学与技术");
        log.info("更新指定 ID 实例 \n" + application);
    }
    ...
    public void test4(){
        String id = "6555b08ab1d3e01affffcb11";
        StudentTransferMajorDocument application = service.updateMajor(id, "新闻学");
        log.info("更新指定 ID 实例 \n" + application);
    }
}

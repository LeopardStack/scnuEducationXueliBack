...
//        log.info("Updating teacher with ID: " + teacherInformationPO.toString() + ", teacher_username: " + account.getAccountName());
    ...
    public void test1() {
        ...
        for (TeacherInformationPO teacherInformationPO : teacherInformationPOS) {
            ...
            if (word_number != null && StrUtil.isNotBlank(word_number)) {
                String account = "T" + word_number;
                PlatformUserVO platformUserVOS = platformUserService.detailByUsername(account);
                if (Objects.isNull(platformUserVOS)) {
//                    log.info("创建成功!");
            ...
            if (id_number != null && StrUtil.isNotBlank(id_number)) {
...
//                    log.info("创建成功!");
            ...
            if (phone != null && StrUtil.isNotBlank(phone)) {

...
public class ExamStudentsInfoVO implements Serializable {
     ...
     * 专业名称
     */
    @ExcelProperty(index = 3, value = "专业名称")
    private String majorName;

    /**
     * 层次
     */
    @ExcelProperty(index = 4, value = "层次")
     ...
     */
    @ExcelProperty(index = 7, value = "本学期采用“线上机考-人脸识别”机考课程名称")
     ...
     * 主讲教师（命题）
     */
    @ExcelProperty(index = 8, value = "主讲教师（命题）")
    private String mainTeacherName;

    /**
     * 主讲老师电话
     */
    @ExcelProperty(index = 9, value = "主讲老师电话")
    private String mainTeacherPhone;

    /**
     * 学号
     */
    @ExcelProperty(index = 10, value = "学号")
    private String studentNumber;

    /**
     * 考生姓名
     */
    @ExcelProperty(index = 11, value = "考生姓名")

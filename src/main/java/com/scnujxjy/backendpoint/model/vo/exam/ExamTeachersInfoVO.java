...
ExamTeachersInfoVO implements Serializable {
     ...
     * 学习形式
     */
    @ExcelProperty(index = 5, value = "学习形式")
     ...
     * 行政班别
     */
    @ExcelProperty(index = 7, value = "行政班别")
    private String className;

    /**
     * 教学班别
     */
    @ExcelProperty(index = 8, value = "教学班别")
     ...
     * 是否用继教学院平台直播上课
     */
    @ExcelProperty(index = 10, value = "是否用继教学院平台直播上课")
    private String xueliPlatform;

    /**
     * 开/闭卷
     */
    @ExcelProperty(index = 11, value = "开/闭卷")
    private String examType;

    /**
     * 主讲教师（命题）
     */
    @ExcelProperty(index = 12, value = "主讲教师（命题）")
    private String mainTeacherName;

    /**
     * 主讲老师电话
     */
    @ExcelProperty(index = 13, value = "主讲老师电话")
    private String mainTeacherPhone;

    /**
     * 辅导教师（阅卷）
     */
    @ExcelProperty(index = 14, value = "辅导教师（阅卷）")
    private String tutorName;

    /**
     * 辅导教师电话
     */
    @ExcelProperty(index = 15, value = "辅导教师电话")

...
public class ScoreInformationDownloadVO implements Serializable {
     ...
     * 政治面貌
     */
    @ExcelProperty(index = 3, value = "政治面貌")
     ...
     * 学院
     */
    @ExcelProperty(index = 6, value = "学院")
     ...
     * 学习形式
     */
    @ExcelProperty(index = 8, value = "学习形式")
     ...
     * 专业名称
     */
    @ExcelProperty(index = 10, value = "专业名称")
    private String majorName;

    /**
     * 学期
     */
    @ExcelProperty(index = 11, value = "学期")
    private String semester;

    /**
     * 课程名称
     */
    @ExcelProperty(index = 12, value = "课程名称")
     ...
     * 课程类型
     */
    @ExcelProperty(index = 13, value = "课程类型")
    private String courseType;

    /**
     * 考核类型
     */
    @ExcelProperty(index = 14, value = "考核类型")
    private String assessmentType;

    /**
     * 总评
     */
    @ExcelProperty(index = 15, value = "总评")
    private String finalScore;

    /**
     * 第一次补考成绩
     */
    @ExcelProperty(index = 16, value = "第一次补考成绩")
    private String makeupExam1Score;

    /**
     * 第二次补考成绩
     */
    @ExcelProperty(index = 17, value = "第二次补考成绩")
    private String makeupExam2Score;

    /**
     * 结业后补考成绩
     */
    @ExcelProperty(index = 18, value = "结业后补考成绩")
     ...
     * 状态
     */
    @ExcelProperty(index = 20, value = "状态")

...
public class EnrollmentPlanController {
    ...
    public SaResult downloadApprovalPlanApplication(@RequestBody EnrollmentPlanApplyRO enrollmentPlanApplyRO) {
    ...
    public SaResult downloadApprovalPlanSummary(@RequestBody EnrollmentPlanApplyRO enrollmentPlanApplyRO) {
